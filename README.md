...
references. Nothing here is published anywhere else, and nothing here is authoritative about a
product: each product documents itself in its own repository.
