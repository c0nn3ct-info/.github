...
const iconButtonVariants = cva(
  'relative inline-flex shrink-0 items-center justify-center font-medium transition-all duration-short ease-emph focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.94] [&_svg]:shrink-0 select-none',
  {
    variants: {
      variant: {
