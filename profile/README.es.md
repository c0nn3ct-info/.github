...
- **Tus datos te pertenecen.** Podrás exportar tus datos en un formato comprensible. No los usamos para crear un perfil sobre ti.
- **Nuestros productos no tienen anuncios.** No incluimos publicidad ni aceptamos dinero para anteponer los intereses de otra persona a los tuyos.
...
Sin formulario ni número de incidencia: el mensaje nos llega directamente.
